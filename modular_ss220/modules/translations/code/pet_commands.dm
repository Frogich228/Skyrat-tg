...
/datum/pet_command/idle
	speech_commands = list("sit", "stay", "stop", "лежать", "место", "сидеть", "стоп", "стой", "сто€ть", "фу")

/datum/pet_command/free
	speech_commands = list("free", "loose", "брысь", "вон", "гул€ть", "свобод", "ждать")
...
/datum/pet_command/beehive/enter
	speech_commands = list("enter", "home", "in", "домой", "домик", "пр€чь", "пр€та")
...
/datum/pet_command/point_targeting/attack/star_gazer
	speech_commands = list("attack", "sic", "kill", "slash them", "атак", "бить", "куса", "куси", "фас", "реж", "резн€")

//ORIGINAL FILE: code/modules/mob/living/basic/icemoon/wolf/wolf_extras.dm
/datum/pet_command/good_boy/wolf
	speech_commands = list("good wolf", "волк", "пес", "пЄс", "хорош")
...
/datum/pet_command/untargeted_ability/summon_toad
	speech_commands = list("frogs", "bombers", "л€гушк", "бомб", "напад")
...
/datum/pet_command/point_targeting/use_ability/take_photo
	speech_commands = list("photo", "picture", "image", "фото", "сними", "сн€ть", "сыр")
